...
@synthesize mangedObjectModel = _mangedObjectModel;
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"w_409_core_data"];
...
//if object preseistent store data store presistent
-(NSManagedObjectContext *) managedObjectContext {
    if(_managedObjectContext != nil){
        return  _managedObjectContext;
    }
    NSPersistentContainer *coordinator = [
...
-(NSManagedObjectModel *) managedObjectModel{
    ...
    NSURL *modelurl = [[NSBundle mainBundle]URLForResource:@"w_409_core_data" withExtension:@"momd"];
